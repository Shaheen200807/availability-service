...
SECRET_KEY = 'django-insecure-jv+948t_-_vy*^_%rdenmslq_!t8yit=e=$ehi41!3w$c-0b5&'
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage",  # <- изменить эту строку
    },
}
